...
public enum ReplayConfigSetting {
        CONFIG_VERSION("Config-Version", 6,
    ...
    PLAYBACK_VIEWER_SAFETY_MODE("Playback.Viewer-Safety-Mode", "creative",
    ...
    PLAYBACK_RESTORE_VIEWER_LOCATION_ON_STOP("Playback.Restore-Viewer-Location-On-Stop", true,
    ...
    PLAYBACK_RESTORE_VIEWER_GAMEMODE_ON_STOP("Playback.Restore-Viewer-GameMode-On-Stop", true,
    ...
    PLAYBACK_RESTORE_VIEWER_FLIGHT_ON_STOP("Playback.Restore-Viewer-Flight-On-Stop", true,
    ...
    PLAYBACK_RESTORE_VIEWER_STATE_ON_REJOIN("Playback.Restore-Viewer-State-On-Rejoin", true,
